...
CREATE INDEX IF NOT EXISTS idx_messages_chat_timestamp ON messages(chat_jid, session_id, timestamp);

SELECT '✅ Sistema multi-agente instalado correctamente' as status;
SELECT COUNT(*) as total_permissions FROM permissions;
SELECT role, COUNT(*) as assigned_permissions FROM role_permissions GROUP BY role;
